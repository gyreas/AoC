...
let tests =
  ...
  >::: [ ("not_fooled_by_flimsy_whitespaces"
       ...
       ; ("can_overlap_subsets"
          >:: fun _ ->
          assert_equal (3, 9, 5) (overlap_subsets (3, 9, 3) (1, 8, 5)) ~printer:ppx_tuple
         )
       ; ("can_get_game_subset"
          >:: fun _ ->
          assert_equal
            ...
            ~printer:ppx_game)
       ; ("can_determine_minimum_color_configuration"
          >:: fun _ ->
          let _ =
            assert_equal
              (4, 22, 6)
...
(*
   Game 1: 3 blue, 4 red; 1 red, 2 green, 6 blue; 2 green                    =>  minimum colors = (4, 2, 6)
   Game 2: 1 blue, 2 green; 3 green, 4 blue, 1 red; 1 green, 1 blue          =>  minimum colors = (1, 3, 4)
   Game 3: 8 green, 6 blue, 20 red; 5 blue, 4 red, 13 green; 5 green, 1 red  =>  minimum colors = (20, 13, 6)
   Game 4: 1 green, 3 red, 6 blue; 3 green, 6 red; 3 green, 15 blue, 14 red  =>  minimum colors = (14, 3, 15)
   Game 5: 6 red, 1 blue, 3 green; 2 blue, 1 red, 2 green                    =>  minimum colors = (6, 3, 2)
